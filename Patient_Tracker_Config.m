...
dataPath = 'C:\Users\cy911\Dropbox\MATLAB_DB\Scanned_Data\';
...
savePositionImage = false;           % Found in mapFloor(s)
runCtd = false;                      % Found in patient_tracker...true means the program will loop
setPastLocSize = false;              % Found in stackResults...will keep historical location set for each beacon down to 10
deletePlots = false;                % Found in mapFloor_BI
